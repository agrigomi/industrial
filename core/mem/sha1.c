...
#define CUSTOM_BGN_DIG_0	0x1ACA889B
#define CUSTOM_BGN_DIG_1	0x0FA3E271
#define CUSTOM_BGN_DIG_2	0x9FFADBF4
#define CUSTOM_BGN_DIG_3	0x61A3F3A1
#define CUSTOM_BGN_DIG_4	0x88AA7C55
...
int SHA1Reset(SHA1Context *context) {
	...
	context->Intermediate_Hash[0] = CUSTOM_BGN_DIG_0;
	context->Intermediate_Hash[1] = CUSTOM_BGN_DIG_1;
	context->Intermediate_Hash[2] = CUSTOM_BGN_DIG_2;
	context->Intermediate_Hash[3] = CUSTOM_BGN_DIG_3;
	context->Intermediate_Hash[4] = CUSTOM_BGN_DIG_4;
