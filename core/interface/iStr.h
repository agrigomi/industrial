...
public:
	...
	virtual _u32 str_len(_str_t str)=0;
	virtual _s32 str_cmp(_str_t str1, _str_t str2)=0;
	virtual _s32 str_ncmp(_str_t str1, _str_t str2, _u32 sz)=0;
	virtual _u32 str_cpy(_str_t dst, _str_t src, _u32 sz_max)=0;
	...
	virtual _s32 find_string(_str_t str1,_str_t str2)=0;
	virtual _str_t toupper(_str_t s)=0;
	virtual _u32 str2i(_str_t str, _s32 sz)=0;
	virtual void trim_left(_str_t str)=0;
	virtual void trim_right(_str_t str)=0;
	virtual void clrspc(_str_t str)=0;
	virtual _u8 div_str(_str_t str,_str_t p1,_u32 sz_p1,_str_t p2,_u32 sz_p2,_cstr_t div)=0;
	virtual _u8 div_str_ex(_str_t str, _str_t p1, _u32 sz_p1, _str_t p2, _u32 sz_p2, _cstr_t div, _s8 start_ex, _s8 stop_ex)=0;
	virtual _u32 wildcmp(_str_t string,_str_t wild)=0;
